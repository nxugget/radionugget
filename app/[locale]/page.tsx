    ...
    <main className="min-h-screen">
      ...
      <section id="space-explore" className="-mt-24 min-h-screen w-full overflow-hidden relative z-0">
        <div className="relative w-full h-screen overflow-hidden">
          ...
          <div
            className={`absolute md:right-0 md:bottom-[12%] inset-0 flex flex-col items-center md:items-end md:justify-end md:mr-24 mx-auto text-center transition-all duration-[1500ms] ${step === 1 ? "opacity-100" : "opacity-0"} ${step === 1 && "md:translate-y-[-50vh]"}`}
            style={{ 
              zIndex: 20, 
              width: "min(90vw, 600px)", 
              maxWidth: "100%",
              marginTop: "-15vh" // Déplace le texte vers le haut sur mobile
            }}
          >
