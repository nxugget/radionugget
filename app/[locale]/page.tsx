...
export async function generateMetadata({
  ...
  const title = isFr ? "Home | RadioNugget" : "Home | RadioNugget";
  ...
  const url = isFr ? "https://radionugget.fr/fr" : "https://radionugget.com/en";
  ...
  const ogImage = {
    ...
    height: 630,
    alt: isFr
      ? "RadioNugget - Exploration radio et spatiale"
      : "RadioNugget - Radio and Space Exploration",
  };
    ...
    other: {
      "application-ld+json": JSON.stringify({
        ...
        audience: {
          "@type": "Audience",
          audienceType:
            "Radio enthusiasts, space enthusiasts, satellite tracking",
        },
      }),
