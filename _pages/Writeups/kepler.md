...
Il est important  de comprendre de quoi on parle quand on évoque les **paramètres d'orbite**. Heureusement pour toi, j'ai fait un petit cours que tu peux consuler [juste ici]({{ site.data.links.tle }}) :) 
...
![Schema challenge](../../assets/img/pages/writeups/kepler/kepler1.svg)
