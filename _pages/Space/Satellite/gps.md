...
Bon, nous, on veut savoir exactement où on est sur **Terre** pour trouver un **McDo**, et les **x,y,z**, ça nous arrange pas. Heureusement pour nous, on peut les convertir en **latitude** et **longitude**. 
...
Et voilà, on est capable de se positionner sur une carte ! On pourrait même aller plus loin pour connaître notre **altitude** mais ça se complexifie encore plus donc on laisse ça de côté pour le moment. 
