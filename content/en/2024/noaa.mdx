...
## APT Transmission
NOAA satellites don’t directly capture photographs of Earth. They use a [scanning radiometer](https://en.wikipedia.org/wiki/Radiom%C3%A8tre_Avanc%C3%A9_%C3%A0_Tr%C3%A8s_Haute_R%C3%A9solution) that performs a slow scan, about 2 lines per second.  
