...
For example, in **France**, the current oscillates at **50Hz**, meaning it changes direction **100 times per second**. That’s what we call **frequency**, measured in [Hertz](https://fr.wikipedia.org/wiki/Hertz).  
A radio is also an oscillator; we refer to a [VFO](https://fr.wikipedia.org/wiki/Oscillateur_%C3%A0_fr%C3%A9quence_variable) (Variable Frequency Oscillator) – a fancy way of saying you can change the frequency.  
...
## Yagi
Yagi antennas, which work from [HF](https://fr.wikipedia.org/wiki/Haute_fr%C3%A9quence) to [UHF](https://fr.wikipedia.org/wiki/Ultra_haute_fr%C3%A9quence), are **directional**. Also known as “rake” antennas, they’re the ones usually seen on rooftops for terrestrial TV.  
