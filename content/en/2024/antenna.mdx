...
The angle between the **2 arms** can be adjusted to fine-tune the **impedance**. When they’re straight as shown, the impedance is `75Ω`. With a `120°` angle, you achieve a `50Ω` match as seen in <SmartLink slug="noaa">this project</SmartLink>.  
