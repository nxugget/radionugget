...
In Universal Radio Hacker, the default decoding method is [NRZ](https://fr.wikipedia.org/wiki/Non_Return_to_Zero). You can see this in the **Analysis** tab marked in red:
