...
We are asked to convert a series of **bits** into an I/Q sample using [QPSK](https://fr.wikipedia.org/wiki/Phase-shift_keying) (Quadrature Phase Shift Keying) modulation.
