...
Ces satellites ont une orbite circulaire qui les font passer d'un pôle à l'autre de la **Terre**. Ce sont des orbites dites **polaire** et plus précisément **héliosynchrone**. Mais pour plus d'infos sur les différents types d'orbites, tu peux cliquer [<SmartLink href="/blog/space/satellite/orbits">ici</SmartLink>].
...
![Prédictions satellite](/images/blog/projects/noaa/prediction_pass.svg)
## Transmission APT
...
Ainsi, je vous recommande de lire les 2 articles que j'ai fais, [<SmartLink href="/blog/radio/basics/antenna">le premier</SmartLink>] pour comprendre comment on choisit une antenne en fonction de la **fréquence** qu'on veut écouter.
...
![Schema antenne v-dipôle](/images/blog/projects/noaa/vdipole_schema.svg)
...
![Antenne v-dipôle](/images/blog/projects/noaa/roof.JPEG)
