...
image: "/images/blog/thumbnail/kepler.webp"
---
...
Il est important  de comprendre de quoi on parle quand on évoque les **paramètres d'orbite**. Heureusement pour toi, j'ai fait un petit cours que tu peux consuler [<SmartLink href="/blog/space/satellite/tle">juste ici</SmartLink>] :) 
...
![Schema challenge](/images/blog/writeups/kepler/kepler1.svg)
