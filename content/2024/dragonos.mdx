...
publishedAt: "23-08-2024"
summary: "Découvrez DragonOS, une distribution Linux conçue pour la radio logicielle (SDR)."
image: "/images/blog/thumbnail/dragonos.webp"
---
La distribution [DragonOS](https://cemaxecuter.com/) est un fork de [Lubuntu](https://lubuntu.fr/) mais spécialisé pour la  [<SmartLink href="/blog/radio/basics/sdr">SDR</SmartLink>]. Elle possède déjà un grand nombre d'outils installés bien pratiques comme par exemple [GNURadio](https://www.gnuradio.org/). C'est super cool pour gagner du temps car nombre de ces tools en radio sont vieux et peuvent être compliqués à mettre en place. 
