...
publishedAt: "12-07-2024"
image: "/images/blog/thumbnail/thomas.webp"
tags: ["writeup", "radio"]
---
...
Pour comprendre le writeup, il est important de comprendre la notion de modulation, alors n'hésite pas à jeter un oeil sur [<SmartLink href="/blog/radio/basics/am">ce cours</SmartLink>] :) 
...
![Universal Radio Hacker](/images/blog/writeups/thomas/thomas1.webp)
Comme pour les 2 précédents challenges, on a plusieurs morceaux, zoomant sur l'un d'entre eux. 

![Universal Radio Hacker](/images/blog/writeups/thomas/thomas2.webp)
Ça ressemble clairement à de l'**ASK**. Si ce type de modulation ne te dit rien, je t'invite à d'abord lire le writeup de [<SmartLink href="/blog/writeups/onandoff">ce challenge</SmartLink>] qui traite d'**ASK**. 
...
![Universal Radio Hacker](/images/blog/writeups/thomas/thomas3.webp)
...
J'oublie pas que durant le [<SmartLink href="/blog/writeups/onandoff">premier challenge</SmartLink>], j'avais pris du temps à comprendre pourquoi ça décoder pas car j'avais laissé le `Pause Threshold` à `8`. Donc, je le remets à `0` pour le désactiver. Et à présent, le signal décodé donne ça : 

![Universal Radio Hacker](/images/blog/writeups/thomas/thomas4.webp)
...
![Universal Radio Hacker](/images/blog/writeups/thomas/thomas5.webp)
...
![Schema Codage de Manchester](/images/blog/writeups/thomas/thomas6.svg)
...
![Universal Radio Hacker](/images/blog/writeups/thomas/thomas7.webp)
