...
image: "/images/blog/thumbnail/tle.webp"
---
...
```
![TLE](/images/blog/space/satellite/tle/tle13.svg)
...
![Orbital Mechanics inclinaison](/images/blog/space/satellite/tle/tle6.webp)
...
![Schema nœud ascendant](/images/blog/space/satellite/tle/tle7.svg)
...
![Schema point vernal](/images/blog/space/satellite/tle/tle8.svg)
...
![Schema Longitude du nœud ascendant](/images/blog/space/satellite/tle/tle14.svg)
...
![Orbital Mechanics Longitude du nœud ascendant](/images/blog/space/satellite/tle/tle9.webp)

# Le demi-grand axe
Bien que non présent dans les **TLE**, ce paramètre est à prendre en compte pour la représentation d'une orbite.

![Schema demi-grand axe](/images/blog/space/satellite/tle/tle1.svg)
...
![Orbital Mechanics demi-grand axe](/images/blog/space/satellite/tle/tle2.webp)
...
![Schema excentricité](/images/blog/space/satellite/tle/tle3.svg)
Changement de `e` :

![Orbital Mechanics excentricité](/images/blog/space/satellite/tle/tle4.webp)

# L'argument du Périastre
Noté `ω`, c'est l'angle en `°` entre le **nœud ascendant** et le **périastre**. 

![Schema argument du Périastre](/images/blog/space/satellite/tle/tle10.svg)
...
![Orbital Mechanics argument du Périastre](/images/blog/space/satellite/tle/tle11.webp)
...
![Schema anomalie vraie](/images/blog/space/satellite/tle/tle12.svg)
