...
L'**ADS-B** pour **A**utomatic **D**ependent **S**urveillance-**B**roadcast permet à un avion d'envoyer **2 fois par seconde** sa position (obtenu via [<SmartLink slug="gps">GNSS</SmartLink>] ainsi que d'autres informations à tous récepteurs pouvant décoder l'**ADSB** comme les aéroports, les autres aéronefs et bientôt, nous :)
...
- Un récepteur [<SmartLink slug="sdr">SDR</SmartLink>]
...
Pour le récepteur, une clé [<SmartLink slug="sdr">SDR</SmartLink>] suffira. Dans mon cas, ce sera le [RTL-SDR V4](https://www.passion-radio.fr/cles-rtl-sdr/r828d-v4-2402.html).
