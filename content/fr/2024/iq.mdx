...
![HackASat IQ challenge](/images/blog/2024/iq/iq1.webp)
...
# Modulation QPSK
La modulation **QPSK** est une modulation de phase **numérique** où l'on va modifier la **phase** de la **porteuse** pour transmettre des données. Tu peux retrouver un cours sur ce qu'est la modulation <SmartLink slug="am">juste là</SmartLink> et sur la phase <SmartLink slug="phase">juste ici</SmartLink>.
...
![QPSK Schema](/images/blog/2024/iq/iq3.webp)
...
![HackASat IQ challenge](/images/blog/2024/iq/iq2.svg)
