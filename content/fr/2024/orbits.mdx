...
![Couverture Galileo](/images/blog/2024/type-orbits/type-orbits4.svg)
 N'hésites pas à consulter <SmartLink slug="gps">juste ici</SmartLink> mon cours sur le **GPS/GNSS** pour comprendre comment ça fonctionne :)
...
C'est cette orbite qu'utilisent les **NOAA** dont on récupéraient les images sur <SmartLink slug="noaa">ce projet</SmartLink>.
