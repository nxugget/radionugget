...
Ces satellites ont une orbite circulaire qui les font passer d'un pôle à l'autre de la **Terre**. Ce sont des orbites dites **polaire** et plus précisément **héliosynchrone**. Mais pour plus d'infos sur les différents types d'orbites, tu peux cliquer <SmartLink slug="orbits">ici</SmartLink>.
...
Ainsi, je vous recommande de lire les 2 articles que j'ai fais, <SmartLink slug="antenna">le premier</SmartLink> pour comprendre comment on choisit une antenne en fonction de la **fréquence** qu'on veut écouter.
<SmartLink slug="sdr">Le second</SmartLink> qui explique ce qu'est la **SDR** (**S**oftware **D**efined **R**adio).
...
![RTL-SDR V4 sur Raspberry](/images/blog/2024/noaa/tupperware.jpg)
