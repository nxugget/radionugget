...
Pour former une constellation **GNSS**, il faut une vingtaine de satellites qui orbitent autour de **la Terre** à une altitude d'environ `20000km` sur l'<SmartLink slug="orbits">orbite terrestre moyenne</SmartLink>. 
