...
export default {
  ...
  navbar: {
    ...
    gallery: "Galerie",
    trackingApp: "Mon App de Tracking",
    english: "English", 
    french: "Français"
  },
  gridSquareInfo: {
    ...
    description3: "Les grid squares divisent le globe en 324 grands territoires (10° par 20°), chacun subdivisé en 100 carrés. Des lettres supplémentaires affinent encore ta position en subdivisant chaque carré.",
  },
  gridSquareCalculator: {
    calculator: "Calculateur"
  },
  projectsSection: {
    title: "Sélection de mes meilleurs projets",
    weatherSatelliteStation: "Station satellite météo",
    satellitePrediction: "Prédiction de satellite",
    decodingSignal: "Décodage de signal",
    satelliteExplorer: "Explorateur de satellites",
    homemadeQfhAntenna: "Antenne QFH maison",
    sstvReception: "Réception SSTV",
    gridSquareCalculator: "Calculateur de Grid Square",
    airTrafficCommunication: "Communication trafic aérien"
  },
  footer: { 
    thanks: "Merci",
